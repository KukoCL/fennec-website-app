export const appTexts = {
  ...
  home: {
    heroSection: {
      ...
      description: 'We help companies transform their business with cutting-edge technology, innovative strategies, and expert consultation to drive growth and success.',
      buttons: {
    ...
    featuresSection: {
      title: 'Our Services',
      description: 'We offer comprehensive business solutions designed to accelerate your company\'s growth and digital transformation.',
      services: {
        webDevelopment: {
    ...
    testimonialsSection: {
      ...
      testimonials: {
        sarahJohnson: 'Fennec Company transformed our business with their innovative solutions. Our productivity increased by 300% and customer satisfaction is at an all-time high.',
        michaelChen: 'The team at Fennec delivered exceptional results. Their expertise in cloud solutions helped us scale our operations seamlessly.',
        emilyRodriguez: 'Outstanding service and support. They understood our vision and delivered a solution that exceeded our expectations.'
      },
      stats: {
    ...
    callToActionSection: {
      ...
      description: 'Join hundreds of satisfied clients who have accelerated their growth with our innovative solutions. Let\'s discuss how we can help you achieve your business goals.',
      buttons: {
