...
export const appTexts = {
  ...
  about: {
    ...
    teamBackground: {
      ...
      paragraphs: [
        'El equipo fundador de Fennec está conformado por profesionales apasionados, resilientes y estratégicos, con ingenieros expertos con más de 10 años de experiencia en el diseño e implementación de soluciones tecnológicas. Su diversidad de talentos y trayectorias —tanto en el sector público como privado— les permite abordar desafíos complejos con enfoque certero, sensibilidad creativa y ejecución efectiva.',
